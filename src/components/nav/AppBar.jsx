...
import SocianAILogoLinkBlue from "../ui/logos/SocianAILogoLinkBlue";
import LandingAppbarDropdown from "./LandingAppbarDropdown";
import Container from "../ui/Container";
import { isMobile } from "react-device-detect";
import { useSelector } from "react-redux";
import MobileText from "../mobile/ui/MobileText";
...
export default function Appbar({ variant = "dark", className }) {
    ...
    >
      <Container>
        ...
        <header
          ...
          aria-label="Global"
        >
          <div className="absolute left-0 flex lg:flex-1">
            {(variant === "dark" && <SocianAILogoLink />) || (
              <SocianAILogoLinkBlue />
            )}
          </div>
