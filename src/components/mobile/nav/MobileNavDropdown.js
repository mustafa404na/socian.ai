...
export default function MobileNavDropdown({ title, children }) {
  return (
    <Popover className="relative">
      {({ open }) => (
        <>
          <Popover.Button
            as={`a`}
            className="text-sm font-semibold text-inherit group inline-flex items-center uppercase cursor-pointer"
          >
            <span>{title}</span>
            <ChevronDownIcon
