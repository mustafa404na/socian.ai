...
import Tanvir from "../../images/about/custom/tanvir.png";
import Adib from "../../images/about/custom/adib.png";
...
export default function AboutCEOsNote() {
  ...
  return (
    <AboutSection title={"Co-founder’s note"}>
      <div className="flex">
        <div className="w-full lg:w-3/4 lg:mt-0 md:mt-5">
          ...
          <p className="paragraph italic mt-0 leading-6 capitalize">
          "As we navigate the ever-evolving landscape of mass media intelligence, I am inspired by the power of data to reshape our understanding of customer engagement. My vision for Socian is rooted in a commitment to clarity amidst the chaos—transforming insights into actionable strategies that drive success. Together, we are not just adapting to change; we are leading it. Let’s embrace innovation and create a future where every decision is informed, strategic, and impactful.”
          </p>
          <div className="flex space-x-6 md:order-2 my-6">
            {ceoSocial.map((item) => (
              <a
                target={"_blank"}
                key={item.name}
