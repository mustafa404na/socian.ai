...
import SocianAILogo from "../../src/components/ui/logos/SocianAILogo";
import SocianSubscriptionForm from "../../src/components/footer/form/SocianSubscriptionForm";
import FooterLinkHeading from "@/components/footer/FooterLinkHeading";

const navigation = {
  about: [
    { name: "Overview", href: "/about#overview" },
    { name: "Partners", href: "/about#SignificantPartners" },
  ],
  products: [
      ...
      <footer aria-labelledby="footer-heading action-1">
        <div className={`mx-auto`}>
          <div className="lg:grid lg:grid-cols-3 lg:gap-8">
            <div className={``}>
              ...
              <div className={`xl:mt-10 mt-4 pr-24 text-lg`}>
                ...
                unparalleled intelligence and automation by merging language,
                AI, and business acumen.
              </div>

              <div className="xl:mt-9 mt-4 flex flex-col gap-y-4">
                <div className="flex items-center">
                  <PhoneIcon className={`w-6 h-6 mr-4`} />
                  <a href="callto:(+880) 132-444-6600">(+880) 132-444-6600</a>
                </div>
            ...
            <div className="grid grid-cols-2 gap-y-8">
              <div>
                ...
                <ul role="list" className="xl:mt-6 mt-1 xl:space-y-4 space-y-1">
          ...
          <div className="border-t mt-4 border-white/10 pt-4 lg:flex lg:items-center lg:justify-between tablet:my-12 mob:my-12">
            <div className="mob:mb-3">
              <h1 className="defultFont">Subscribe to our newsletter</h1>
            </div>

            <SocianSubscriptionForm />
          </div>
          <div className="flex mob:flex-col mt-4 border-t border-white/10 pt-4 items-center justify-between mob:items-start">
            ...
            <p className="mt-8 mb-5 text-md leading-5 text-gray-400 md:order-1 md:mt-0">
              &copy; {new Date().getFullYear()} Socian AI. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
